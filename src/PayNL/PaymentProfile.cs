...
using PaymentProfileGet = PayNL.API.PaymentProfile.Get.Request;
using PaymentProfileGetAll = PayNL.API.PaymentProfile.GetAll.Request;
using PaymentProfileGetAvailable = PayNL.API.PaymentProfile.GetAvailable.Request;
