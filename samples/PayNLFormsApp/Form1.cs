...
namespace PayNLFormsApp
{
    public partial class Form1 : Form
    {
        ...
        {
            /*
            AddDebug(PayNL.Enums.Util.ToEnumString<PayNL.Enums.TaxClass>(PayNL.Enums.TaxClass.High));
            AddDebug(PayNL.Enums.Util.ToEnumString(PayNL.Enums.TaxClass.High, typeof(PayNL.Enums.TaxClass)));
        ...
        private async void PaymentProfilesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                ClearDebug();
                var fixture = new PayNL.API.PaymentProfile.GetAll.Request();
                InitRequestDebug(fixture);
                DumpNvc(fixture.GetParameters());
        ...
        class X
        {
            [JsonProperty("gender"), JsonConverter(typeof(PayNL.Converters.GenderConverter))]
            public PayNL.Enums.Gender Gender { get; set; }
    ...
    public class TestYMD
    {
        ...
        /// Merchant ID
        /// </summary>
        [JsonProperty("dt"), JsonConverter(typeof(PayNL.Converters.YMDConverter))]
    ...
    public class TestDMY
    {
        ...
        /// Merchant ID
        /// </summary>
        [JsonProperty("dt"), JsonConverter(typeof(PayNL.Converters.DMYConverter))]
        public DateTime? DT { get; set; }
    }
    public class TestYMDHIS
    {
        ...
        /// Merchant ID
        /// </summary>
        [JsonProperty("dt"), JsonConverter(typeof(PayNL.Converters.YMDHISConverter))]
        public DateTime? DT { get; set; }
    }
}
