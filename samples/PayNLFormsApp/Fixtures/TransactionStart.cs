using System;
using PayNL.API.Transaction.Start;
using PayNL;
using PayNL.Enums;
...
namespace PayNLFormsApp.Fixtures
{
    public class TransactionStart
    {
        ...
        public Request GetFixture()
        {
            ...
            request.Enduser.InvoiceAddress = new PayNL.Objects.Address
            {
                Initials = "J.",
                LastName = "Jansen",
                Gender = Gender.Male,
            ...
            request.SalesData = new PayNL.Objects.SalesData
            {
                ...
                OrderData = new System.Collections.Generic.List<PayNL.Objects.OrderData>()
            };
            request.SalesData.OrderData.Add(new PayNL.Objects.OrderData("SKU-8489", 2995));
            request.SalesData.OrderData.Add(new PayNL.Objects.OrderData("SKU-8421", 995));
            request.SalesData.OrderData.Add(new PayNL.Objects.OrderData("SKU-2359", 2499));
